results1 = zeros(1900,1, 'double');
%results2 = zeros(320,1, 'double');
%results3 = zeros(320,1, 'double');
%results4 = zeros(320,1, 'double');
input = zeros(1900, 1, 'double');
delete(instrfindall);
try
    
    nucleo144 = serial('COM3','BaudRate',230400);%460800
    fopen(nucleo144);
    for i = 1:1900
